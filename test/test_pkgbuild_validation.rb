...
class TestLoadPkgbuild < Minitest::Test
  ...
  def test_raises_when_pkgbuild_missing
    assert_raises(Rulepack::PkgbuildNotFound, /PKGBUILD not found/) do
      Rulepack::Validation.load_pkgbuild(@pkgdir)
    end
  end
  ...
  def test_raises_when_missing_targets
    ...
    result = Rulepack::Validation.load_pkgbuild(@pkgdir)
...
class TestValidatePkgbuild < Minitest::Test
  def test_valid_minimal_package_passes
    ...
    assert Rulepack::Validation.validate_pkgbuild(pkg, '/fake/dir'), 'valid package should pass validation'
  end
  ...
  def test_invalid_pkgname_uppercase
    ...
    result = Rulepack::Validation.validate_pkgbuild(pkg, '/fake')
  ...
  def test_url_source_with_valid_sha256_passes
    ...
    assert Rulepack::Validation.validate_pkgbuild(pkg, '/fake'), 'valid url source should pass'
  end
