...
class TestLoadPkgbuild < Minitest::Test
  ...
  def test_loads_valid_pkgbuild
    ...
    data = Ssot::Lib::Common.load_pkgbuild(@pkgdir)
  ...
  def test_raises_when_pkgbuild_missing
    assert_raises(RuntimeError, /PKGBUILD not found/) do
      Ssot::Lib::Common.load_pkgbuild(@pkgdir)
    end
  end
...
class TestValidatePkgbuild < Minitest::Test
  def test_valid_minimal_package_passes
    ...
    assert Ssot::Lib::Common.validate_pkgbuild(pkg, '/fake/dir'), 'valid package should pass validation'
  end
  ...
  def test_invalid_pkgname_uppercase
    ...
    result = Ssot::Lib::Common.validate_pkgbuild(pkg, '/fake')
  ...
  def test_url_source_with_valid_sha256_passes
    ...
    assert Ssot::Lib::Common.validate_pkgbuild(pkg, '/fake'), 'valid url source should pass'
  end
