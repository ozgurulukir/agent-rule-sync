...
description: >
  Generates or updates RBS-inline type annotations directly in Ruby source files
  as comments. Triggers when creating, updating, or maintaining inline type
  signatures for Ruby source files.
---
...
- See `reference/syntax.md` for the full RBS-inline syntax guide.
- Pay extra attention to `Data` and `Struct` types.
- See `reference/data-struct-support.md` for Data and Struct handling.
...
- `reference/syntax.md` — RBS-inline syntax guide
- `reference/data-struct-support.md` — Data and Struct handling in rbs-inline
