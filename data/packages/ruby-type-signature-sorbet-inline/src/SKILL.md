...
description: >
  Generates or updates Sorbet inline type signatures directly in Ruby source
  files using sig {} blocks. Triggers when creating, updating, or maintaining
  inline type signatures for Ruby source files.
---
...
- See `reference/syntax.md` for the full Sorbet syntax guide.
...
- `reference/syntax.md` — Sorbet signature syntax guide
